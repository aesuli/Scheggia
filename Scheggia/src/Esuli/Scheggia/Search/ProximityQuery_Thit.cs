...
namespace Esuli.Scheggia.Search
{
    ...
    public class ProximityQuery<Thit> 
        : IQuery<Thit>
        where Thit : IPositionalHit<Thit>, IComparable<Thit>
    {
        ...
        public ProximityQuery(IQuery<Thit>[] arguments, int maxDistance)
        {
        ...
        {
            StringBuilder description = new StringBuilder("PROXIMITY ( ");
            description.Append(maxDistance);
            description.Append(" , ");
        ...
        public IPostingEnumerator<Thit> ApplySpecialized(IIndex index)
        {
            ...
            return ProximityPostingEnumerator<Thit>.Build(enumerators,maxDistance);
        }
    }
}
